    ...
    <>
      ...
      <div class="main-shell" style={{
        ...
        <h1 style={{
          ...
          Мир Квизов — образовательная платформа нового поколения
        </h1>
        <h2 style={{
        ...
        <div style={{
          ...
          <p>
            <b>Мир Квизов</b> — это современная образовательная платформа, объединяющая всех участников учебного процесса. Здесь вы можете:
          </p>
